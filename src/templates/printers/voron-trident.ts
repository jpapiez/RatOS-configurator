...
const getSizeConfig = (config: PrinterConfiguration) =>
	config.size.x === 300 && config.size.z === 250 ? '300-250' : config.size.x;
...
[include RatOS/printers/voron-trident/${getSizeConfig(config)}.cfg]
