...
#############################################################################################################
${helper.renderBase()}
[include RatOS/printers/pfa-saladfork/pfa-saladfork.cfg]
[include RatOS/printers/pfa-saladfork/macros.cfg]
[include RatOS/printers/pfa-saladfork/${config.size.x}.cfg]
...
${helper.renderUserStepperSections({
	...
	z: {
		...
		rotationComment: '8 for TR8*8 lead screws',
		limits: {
			min: 0,
			max: config.size.z,
		},
